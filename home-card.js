...
(function () {
  ...
  var CSS = [
    ...
    '#sh-card .sh-micro{color:rgba(255,255,255,.85);text-shadow:0 1px 6px rgba(0,0,0,.5)}',
    ...
    '@media(max-width:768px){#sh-card{display:none!important}#sh-band{display:block}}'
  ].join('');
